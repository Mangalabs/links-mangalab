...
import Icon from './assets/icon-mangabg.webp'
      ...
      <main className='relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-4 sm:py-6 overflow-y-auto'>
        <div className='w-full max-w-2xl mx-auto flex flex-col justify-center gap-3 sm:gap-4'>
          <header className='flex flex-col items-center gap-1.5 sm:gap-3'>
            <div className='w-18 h-18 xs:w-14 xs:h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl overflow-hidden border-2 border-[#FDCD00]/30'>
              <img
                src={Icon}
                alt='Logo MangaLab'
            ...
            <div className='relative'>
              <h1 className='text-3xl xs:text-4xl sm:text-5xl md:text-6xl text-white tracking-wide font-bold'>
                <span className='bg-linear-to-r from-[#FDCD00] via-[#E9972D] to-[#FDCD00] bg-clip-text text-transparent'>
                  MangaLab
                </span>
              </h1>
              <div
                className='absolute inset-0 blur-xl opacity-30 bg-linear-to-r from-[#FDCD00] to-[#E9972D] pointer-events-none'
                aria-hidden='true'
              />
            </div>
          </header>
          ...
          <nav
            ...
            <LinkButton
              ...
              href='https://wa.me/5585992961295?text=Oi!%20Quero%20saber%20mais%20sobre%20o%20trabalho%20da%20MangaLab.'
            />
          </nav>
        </div>
      </main>
